...
Future<void> fliterBookByGenre(BuildContext context, WidgetRef ref) async {
  String? selectedLanguage = ref.read(bookFilterLanguageProvider);
  String? selectedGenre = ref.read(bookFilterGenreProvider);
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ref.read(bookFilterLanguageProvider.notifier).state =
                          selectedLanguage;
                      ref.read(bookFilterGenreProvider.notifier).state =
                          selectedGenre;
                      Navigator.pop(context);
                    },
                    child: Text(
