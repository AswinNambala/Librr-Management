...
class NotificationScreen extends StatelessWidget {
  ...
  Future<void> _confirmClearAll(BuildContext context, Box<NotificationClass> box) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const AppBarForAll(appBarTitle: 'Notifications', navToBorrow: false),
      body: ValueListenableBuilder(
        valueListenable: box.listenable(),
        builder: (context, Box<NotificationClass> box, _) {
          if (box.isEmpty) {
            return Center(child: Text('No notifications', style: Theme.of(context).textTheme.bodyLarge));
          }
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          trailing: Text(
                            DateFormat('dd MMM, hh:mm a').format(notification.time),
