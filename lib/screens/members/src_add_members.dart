...
import 'package:librrr_management/controllers/db%20functions/members_db_utils.dart';
import 'package:librrr_management/models/members/members_class.dart';
import 'package:librrr_management/controllers/common%20functions/member_utils.dart';
              ...
              child: Column(
                children: [
                  ...
                  AllTextFormField(
                    ...
                    readOnly: true,
                    onTap: () =>
                        MemberUtils.addMemberSelectGender(context, (gender) {
                      setState(() {
                        mGender.text = gender;
                      });
                    }),
                      ...
                      if (paymentSection)
                        if (!paymentCompleted)
                          ElevatedButton(
                              ...
                              onPressed: () async {
                                bool cases =
                                    await MemberUtils.bottomsheetforPayment(
                                        context);
                                if (cases) {
                                  setState(() {
